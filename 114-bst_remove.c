 ...
 * @root: A pter to the root node of the BST to search.
 *
 ...
 * @root: A pnter to the root node of the BST to remove a node from.
 * @node: A pter to the current node in the BST.
 * @value: The value to remove from the BST.
 *
 * Return: A pter to the root node after deletion.
 */
bst_t *bst_remove_recursive(bst_t *root, bst_t *node, int value)
{
	if (node != NULL)
